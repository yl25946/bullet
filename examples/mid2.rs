...
fn main() {
    ...
    let schedule = TrainingSchedule {
        ...
        // start = loss rate
        lr_scheduler: lr::StepLR { start: 0.001, gamma: 0.3, step: 200 },
    ...
    let settings =
        LocalSettings { threads: 4, data_file_paths: vec!["../NNUE Data/test80-aug2022-shuffled.bin"], output_directory: "checkpoints" };
